      ...
      */}
      <section className="grid grid-cols-1 md:grid-cols-2 w-full max-w-7xl mx-auto px-6 gap-8">
        ...
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left px-4 md:px-20 gap-6">
          <h1
            className={`text-4xl md:text-5xl lg:text-6xl font-bold leading-tight ${handjet.className}`}
          >
          ...
          <div className="flex space-x-4 list-none">
            <Link href="/shorten">
              <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-xl transition-all cursor-pointer">
                Try Now
              </button>
            </Link>
            <Link
              ...
              target="_blank"
            >
              <button className="hover:bg-blue-500 hover:text-white text-blue-500 border-2 border-blue-500 font-bold py-3 px-6 rounded-xl transition-all cursor-pointer">
                Github
              </button>
            </Link>
          </div>
